...
Future<void> exportSalesDataToExcel(List<Map<String, dynamic>> salesData, List<String> productNames) async {
  if (salesData.isEmpty || productNames.isEmpty) {
  ...
  String fileName = '$dir/SalesData_$formattedDate.xlsx';
